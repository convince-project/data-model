...
: ${AMENT_CURRENT_PREFIX:="/convince_ws/install/place_object_skill"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/place_object_skill/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/place_object_skill/environment/path.sh"
