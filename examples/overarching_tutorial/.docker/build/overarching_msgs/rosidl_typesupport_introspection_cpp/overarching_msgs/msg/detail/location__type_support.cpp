...
{
  new (message_memory) overarching_msgs::msg::Location(_init);
}

void Location_fini_function(void * message_memory)
{
  auto typed_message = static_cast<overarching_msgs::msg::Location *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Location_message_member_array[3] = {
  {
    ...
    offsetof(overarching_msgs::msg::Location, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(overarching_msgs::msg::Location, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(overarching_msgs::msg::Location, parent),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Location_message_members = {
  "overarching_msgs::msg",  // message namespace
  "Location",  // message name
  3,  // number of fields
  sizeof(overarching_msgs::msg::Location),
...
{
  return &::overarching_msgs::msg::rosidl_typesupport_introspection_cpp::Location_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, overarching_msgs, msg, Location)() {
  return &::overarching_msgs::msg::rosidl_typesupport_introspection_cpp::Location_message_type_support_handle;
}
