    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'overarching_msgs.action.Place_Goal')
            logger.debug(
...
class Metaclass_Place_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'overarching_msgs.action.Place_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Place_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'overarching_msgs.action.Place_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Place_SendGoal_Request(metaclass=Metaclass_Place_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'overarching_msgs/Place_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['overarching_msgs', 'action'], 'Place_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from overarching_msgs.action._place import Place_Goal
...
class Place_SendGoal_Event(metaclass=Metaclass_Place_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<overarching_msgs/Place_SendGoal_Request, 1>',
        'response': 'sequence<overarching_msgs/Place_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['overarching_msgs', 'action'], 'Place_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['overarching_msgs', 'action'], 'Place_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from overarching_msgs.action import Place_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from overarching_msgs.action import Place_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Place_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'overarching_msgs.action.Place_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from overarching_msgs.action import _place
...
class Place_SendGoal(metaclass=Metaclass_Place_SendGoal):
    from overarching_msgs.action._place import Place_SendGoal_Request as Request
    from overarching_msgs.action._place import Place_SendGoal_Response as Response
    from overarching_msgs.action._place import Place_SendGoal_Event as Event
...
class Place_GetResult_Response(metaclass=Metaclass_Place_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'overarching_msgs/Place_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['overarching_msgs', 'action'], 'Place_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from overarching_msgs.action._place import Place_Result
...
class Place_GetResult_Event(metaclass=Metaclass_Place_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<overarching_msgs/Place_GetResult_Request, 1>',
        'response': 'sequence<overarching_msgs/Place_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['overarching_msgs', 'action'], 'Place_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['overarching_msgs', 'action'], 'Place_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from overarching_msgs.action import Place_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from overarching_msgs.action import Place_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Place_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'overarching_msgs.action.Place_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Place_GetResult(metaclass=Metaclass_Place_GetResult):
    from overarching_msgs.action._place import Place_GetResult_Request as Request
    from overarching_msgs.action._place import Place_GetResult_Response as Response
    from overarching_msgs.action._place import Place_GetResult_Event as Event
...
class Metaclass_Place_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'overarching_msgs.action.Place_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Place_FeedbackMessage(metaclass=Metaclass_Place_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'overarching_msgs/Place_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['overarching_msgs', 'action'], 'Place_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from overarching_msgs.action._place import Place_Feedback
...
class Place(metaclass=Metaclass_Place):
    ...
    from overarching_msgs.action._place import Place_Goal as Goal
    # The result message defined in the action definition.
    from overarching_msgs.action._place import Place_Result as Result
    # The feedback message defined in the action definition.
    from overarching_msgs.action._place import Place_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from overarching_msgs.action._place import Place_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from overarching_msgs.action._place import Place_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from overarching_msgs.action._place import Place_FeedbackMessage as FeedbackMessage
