...
#include "overarching_msgs/msg/detail/location__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const overarching_msgs::msg::Location & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::msg::Location & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = overarching_msgs::msg::Location;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const overarching_msgs::msg::Location *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<overarching_msgs::msg::Location *>(
    untyped_ros_message);
...
get_message_type_support_handle<overarching_msgs::msg::Location>()
{
  return &overarching_msgs::msg::typesupport_fastrtps_cpp::_Location__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, msg, Location)() {
  return &overarching_msgs::msg::typesupport_fastrtps_cpp::_Location__handle;
}
