...
#include "overarching_msgs/action/detail/place__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const overarching_msgs::action::Place_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_Goal & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = overarching_msgs::action::Place_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_Goal *>(
    untyped_ros_message);
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_Goal)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: structure_needs_at_least_one_member
  cdr << ros_message.structure_needs_at_least_one_member;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_Result & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_Result;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_Result)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: structure_needs_at_least_one_member
  cdr << ros_message.structure_needs_at_least_one_member;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_Feedback & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_Feedback;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_Feedback)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_Feedback__handle;
}
...
// functions for overarching_msgs::action::Place_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Place_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_SendGoal_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_Place_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_SendGoal_Request)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_SendGoal_Response)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_SendGoal_Response__handle;
}
...
// functions for overarching_msgs::action::Place_SendGoal_Request already declared above

// functions for overarching_msgs::action::Place_SendGoal_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_SendGoal_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_SendGoal_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Place_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Place_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_SendGoal_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_Place_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_Place_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_SendGoal_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_SendGoal_Event)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_SendGoal_Event__handle;
}
...
static const rosidl_service_type_support_t _Place_SendGoal__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<overarching_msgs::action::Place_SendGoal_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<overarching_msgs::action::Place_SendGoal_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<overarching_msgs::action::Place_SendGoal_Event>(),
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_SendGoal)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_GetResult_Request)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for overarching_msgs::action::Place_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Place_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_GetResult_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_Place_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_GetResult_Response)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_GetResult_Response__handle;
}
...
// functions for overarching_msgs::action::Place_GetResult_Request already declared above

// functions for overarching_msgs::action::Place_GetResult_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_GetResult_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_GetResult_Event & ros_message)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.info);
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Place_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Place_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_Place_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_Place_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_GetResult_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_GetResult_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_GetResult_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_GetResult_Event)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_GetResult_Event__handle;
}
...
static const rosidl_service_type_support_t _Place_GetResult__handle{
  ...
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<overarching_msgs::action::Place_GetResult_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<overarching_msgs::action::Place_GetResult_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<overarching_msgs::action::Place_GetResult_Event>(),
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_GetResult)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_GetResult__handle;
}
...
// functions for overarching_msgs::action::Place_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_overarching_msgs
cdr_serialize(
  const overarching_msgs::action::Place_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  overarching_msgs::action::Place_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_Place_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = overarching_msgs::action::Place_FeedbackMessage;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        overarching_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_key_Place_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const overarching_msgs::action::Place_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<overarching_msgs::action::Place_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, overarching_msgs, action, Place_FeedbackMessage)() {
  return &overarching_msgs::action::typesupport_fastrtps_cpp::_Place_FeedbackMessage__handle;
}
