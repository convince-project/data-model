...
#include "overarching_msgs/msg/detail/location__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // parent
#include "rosidl_runtime_c/string_functions.h"  // parent

// forward declare type support functions


using _Location__ros_msg_type = overarching_msgs__msg__Location;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = overarching_msgs__msg__Location;
    is_plain =
      (
      offsetof(DataType, parent) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const overarching_msgs__msg__Location * ros_message = static_cast<const overarching_msgs__msg__Location *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_overarching_msgs__msg__Location(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  overarching_msgs__msg__Location * ros_message = static_cast<overarching_msgs__msg__Location *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_overarching_msgs__msg__Location(cdr, ros_message);
}

static uint32_t _Location__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_overarching_msgs__msg__Location(
...
static size_t _Location__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_overarching_msgs__msg__Location(
