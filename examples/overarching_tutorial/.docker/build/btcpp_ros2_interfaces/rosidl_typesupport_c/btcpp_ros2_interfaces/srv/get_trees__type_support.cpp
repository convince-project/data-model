...
static const _GetTrees_Event_type_support_symbol_names_t _GetTrees_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, btcpp_ros2_interfaces, srv, GetTrees_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, btcpp_ros2_interfaces, srv, GetTrees_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, btcpp_ros2_interfaces, srv, GetTrees_Event)() {
  return &::btcpp_ros2_interfaces::srv::rosidl_typesupport_c::GetTrees_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetTrees_service_type_support_handle = {
  ...
  &GetTrees_Request_message_type_support_handle,
  &GetTrees_Response_message_type_support_handle,
  &GetTrees_Event_message_type_support_handle,
