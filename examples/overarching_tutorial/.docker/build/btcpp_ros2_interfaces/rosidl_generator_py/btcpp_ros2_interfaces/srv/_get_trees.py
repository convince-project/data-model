...
class Metaclass_GetTrees_Event(type):
    """Metaclass of message 'GetTrees_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'btcpp_ros2_interfaces.srv.GetTrees_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_trees__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_trees__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_trees__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_trees__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_trees__event
...
class GetTrees_Event(metaclass=Metaclass_GetTrees_Event):
    """Message class 'GetTrees_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<btcpp_ros2_interfaces/GetTrees_Request, 1>',
        'response': 'sequence<btcpp_ros2_interfaces/GetTrees_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['btcpp_ros2_interfaces', 'srv'], 'GetTrees_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['btcpp_ros2_interfaces', 'srv'], 'GetTrees_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from btcpp_ros2_interfaces.srv import GetTrees_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetTrees_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetTrees_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from btcpp_ros2_interfaces.srv import GetTrees_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetTrees_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetTrees_Response'"
...
class Metaclass_GetTrees(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_trees.Metaclass_GetTrees_Event._TYPE_SUPPORT is None:
                _get_trees.Metaclass_GetTrees_Event.__import_type_support__()
...
class GetTrees(metaclass=Metaclass_GetTrees):
    ...
    from btcpp_ros2_interfaces.srv._get_trees import GetTrees_Event as Event
