...
static char pyrobosim_msgs__msg__WorldState__FIELD_NAME__robots[] = "robots";
static char pyrobosim_msgs__msg__WorldState__FIELD_NAME__locations[] = "locations";
static char pyrobosim_msgs__msg__WorldState__FIELD_NAME__hallways[] = "hallways";
static char pyrobosim_msgs__msg__WorldState__FIELD_NAME__objects[] = "objects";

static rosidl_runtime_c__type_description__Field pyrobosim_msgs__msg__WorldState__FIELDS[] = {
  {
    {pyrobosim_msgs__msg__WorldState__FIELD_NAME__robots, 6, 6},
    {
  ...
  {
    {pyrobosim_msgs__msg__WorldState__FIELD_NAME__locations, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {pyrobosim_msgs__msg__WorldState__FIELD_NAME__hallways, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {pyrobosim_msgs__msg__WorldState__FIELD_NAME__objects, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription pyrobosim_msgs__msg__WorldState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {pyrobosim_msgs__msg__WorldState__FIELDS, 4, 4},
    },
    {pyrobosim_msgs__msg__WorldState__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
...
pyrobosim_msgs__msg__WorldState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *pyrobosim_msgs__msg__WorldState__get_individual_type_description_source(NULL),
