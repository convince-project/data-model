...
#include "pyrobosim_msgs/msg/detail/location_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // category, name, parent, spawns
#include "rosidl_runtime_c/string_functions.h"  // category, name, parent, spawns
...
using _LocationState__ros_msg_type = pyrobosim_msgs__msg__LocationState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: spawns
  {
    ...
    auto array_ptr = ros_message->spawns.data;
  ...
  pyrobosim_msgs__msg__LocationState * ros_message)
{
  ...
  // Field name: spawns
  {
    ...
    if (ros_message->spawns.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->spawns);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->spawns, size)) {
      fprintf(stderr, "failed to create array for field 'spawns'");
      return false;
    }
    auto array_ptr = ros_message->spawns.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'spawns'\n");
        return false;
      }
    }
  }
...
size_t get_serialized_size_pyrobosim_msgs__msg__LocationState(
  ...
  size_t current_alignment)
{
  const _LocationState__ros_msg_type * ros_message = static_cast<const _LocationState__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: spawns
  {
    size_t array_size = ros_message->spawns.size;
    auto array_ptr = ros_message->spawns.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pyrobosim_msgs__msg__LocationState;
    is_plain =
      (
...
static bool _LocationState__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const pyrobosim_msgs__msg__LocationState * ros_message = static_cast<const pyrobosim_msgs__msg__LocationState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_pyrobosim_msgs__msg__LocationState(ros_message, cdr);
}

static bool _LocationState__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  pyrobosim_msgs__msg__LocationState * ros_message = static_cast<pyrobosim_msgs__msg__LocationState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_pyrobosim_msgs__msg__LocationState(cdr, ros_message);
}

static uint32_t _LocationState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pyrobosim_msgs__msg__LocationState(
      untyped_ros_message, 0));
}

static size_t _LocationState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_pyrobosim_msgs__msg__LocationState(
...
static message_type_support_callbacks_t __callbacks_LocationState = {
  "pyrobosim_msgs::msg",
  "LocationState",
  _LocationState__cdr_serialize,
  _LocationState__cdr_deserialize,
  _LocationState__get_serialized_size,
  _LocationState__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _LocationState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LocationState,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pyrobosim_msgs, msg, LocationState)() {
  return &_LocationState__type_support;
}
