...
{
  new (message_memory) pyrobosim_msgs::msg::Path(_init);
}

void Path_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pyrobosim_msgs::msg::Path *>(message_memory);
  typed_message->~Path();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Path_message_member_array[2] = {
  {
    ...
    offsetof(pyrobosim_msgs::msg::Path, poses),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pyrobosim_msgs::msg::Path, length),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Path_message_members = {
  ...
  "Path",  // message name
  2,  // number of fields
  sizeof(pyrobosim_msgs::msg::Path),
...
get_message_type_support_handle<pyrobosim_msgs::msg::Path>()
{
  return &::pyrobosim_msgs::msg::rosidl_typesupport_introspection_cpp::Path_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pyrobosim_msgs, msg, Path)() {
  return &::pyrobosim_msgs::msg::rosidl_typesupport_introspection_cpp::Path_message_type_support_handle;
}
