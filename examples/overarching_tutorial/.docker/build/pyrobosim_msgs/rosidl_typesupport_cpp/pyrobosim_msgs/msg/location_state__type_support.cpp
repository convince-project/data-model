...
static const _LocationState_type_support_symbol_names_t _LocationState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pyrobosim_msgs, msg, LocationState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pyrobosim_msgs, msg, LocationState)),
  }
};
...
{
  return &::pyrobosim_msgs::msg::rosidl_typesupport_cpp::LocationState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pyrobosim_msgs, msg, LocationState)() {
  return get_message_type_support_handle<pyrobosim_msgs::msg::LocationState>();
}
