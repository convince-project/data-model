...
#include "pyrobosim_msgs/msg/detail/path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pyrobosim_msgs::msg::Path & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pyrobosim_msgs::msg::Path & ros_message)
{
  // Member: poses
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pyrobosim_msgs::msg::Path;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pyrobosim_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pyrobosim_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  return &pyrobosim_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pyrobosim_msgs, msg, Path)() {
  return &pyrobosim_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
