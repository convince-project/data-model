...
#include "pyrobosim_msgs/msg/detail/task_plan__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pyrobosim_msgs::msg::TaskPlan;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pyrobosim_msgs::msg::TaskPlan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pyrobosim_msgs::msg::TaskPlan *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TaskPlan__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pyrobosim_msgs::msg::TaskPlan *>(
...
static size_t _TaskPlan__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TaskPlan(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TaskPlan__callbacks = {
  "pyrobosim_msgs::msg",
  "TaskPlan",
...
static rosidl_message_type_support_t _TaskPlan__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TaskPlan__callbacks,
...
{
  return &pyrobosim_msgs::msg::typesupport_fastrtps_cpp::_TaskPlan__handle;
}
