...
#include "pyrobosim_msgs/msg/detail/task_action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pyrobosim_msgs::msg::TaskAction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pyrobosim_msgs::msg::TaskAction & ros_message)
{
  // Member: robot
  cdr >> ros_message.robot;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pyrobosim_msgs::msg::TaskAction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pyrobosim_msgs::msg::TaskAction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pyrobosim_msgs::msg::TaskAction *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TaskAction__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pyrobosim_msgs::msg::TaskAction *>(
...
static size_t _TaskAction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TaskAction(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TaskAction__callbacks = {
  "pyrobosim_msgs::msg",
  "TaskAction",
...
static rosidl_message_type_support_t _TaskAction__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TaskAction__callbacks,
...
{
  return &pyrobosim_msgs::msg::typesupport_fastrtps_cpp::_TaskAction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pyrobosim_msgs, msg, TaskAction)() {
  return &pyrobosim_msgs::msg::typesupport_fastrtps_cpp::_TaskAction__handle;
}
