...
bool pyrobosim_msgs__msg__object_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pyrobosim_msgs.msg._object_state.ObjectState", full_classname_dest, 44) == 0);
  }
  pyrobosim_msgs__msg__ObjectState * ros_message = _ros_message;
  {  // name
...
PyObject * pyrobosim_msgs__msg__object_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pyrobosim_msgs.msg._object_state");
