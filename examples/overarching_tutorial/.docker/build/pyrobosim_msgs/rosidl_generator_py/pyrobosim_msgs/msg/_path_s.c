...
bool pyrobosim_msgs__msg__path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pyrobosim_msgs.msg._path.Path", full_classname_dest, 29) == 0);
  }
  pyrobosim_msgs__msg__Path * ros_message = _ros_message;
  {  // poses
...
PyObject * pyrobosim_msgs__msg__path__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pyrobosim_msgs.msg._path");
