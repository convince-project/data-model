...
static const _ActionResponse_type_support_symbol_names_t _ActionResponse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bt_interfaces_dummy, msg, ActionResponse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bt_interfaces_dummy, msg, ActionResponse)),
  }
};
...
{
  return &::bt_interfaces_dummy::msg::rosidl_typesupport_cpp::ActionResponse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bt_interfaces_dummy, msg, ActionResponse)() {
  return get_message_type_support_handle<bt_interfaces_dummy::msg::ActionResponse>();
}
