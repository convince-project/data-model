...
bt_interfaces_dummy__msg__ActionResponse__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bt_interfaces_dummy__msg__ActionResponse * msg = (bt_interfaces_dummy__msg__ActionResponse *)allocator.allocate(sizeof(bt_interfaces_dummy__msg__ActionResponse), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bt_interfaces_dummy__msg__ActionResponse));
  bool success = bt_interfaces_dummy__msg__ActionResponse__init(msg);
  if (!success) {
...
bt_interfaces_dummy__msg__ActionResponse__destroy(bt_interfaces_dummy__msg__ActionResponse * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    bt_interfaces_dummy__msg__ActionResponse__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bt_interfaces_dummy__msg__ActionResponse__Sequence__init(bt_interfaces_dummy__msg__ActionResponse__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bt_interfaces_dummy__msg__ActionResponse * data = NULL;

  if (size) {
    data = (bt_interfaces_dummy__msg__ActionResponse *)allocator.zero_allocate(size, sizeof(bt_interfaces_dummy__msg__ActionResponse), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bt_interfaces_dummy__msg__ActionResponse__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bt_interfaces_dummy__msg__ActionResponse__fini(&data[i - 1]);
      }
...
bt_interfaces_dummy__msg__ActionResponse__Sequence__fini(bt_interfaces_dummy__msg__ActionResponse__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bt_interfaces_dummy__msg__ActionResponse__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bt_interfaces_dummy__msg__ActionResponse__Sequence * array = (bt_interfaces_dummy__msg__ActionResponse__Sequence *)allocator.allocate(sizeof(bt_interfaces_dummy__msg__ActionResponse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bt_interfaces_dummy__msg__ActionResponse__Sequence__init(array, size);
  if (!success) {
...
bt_interfaces_dummy__msg__ActionResponse__Sequence__destroy(bt_interfaces_dummy__msg__ActionResponse__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bt_interfaces_dummy__msg__ActionResponse__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bt_interfaces_dummy__msg__ActionResponse__Sequence__are_equal(const bt_interfaces_dummy__msg__ActionResponse__Sequence * lhs, const bt_interfaces_dummy__msg__ActionResponse__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bt_interfaces_dummy__msg__ActionResponse__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bt_interfaces_dummy__msg__ActionResponse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bt_interfaces_dummy__msg__ActionResponse);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bt_interfaces_dummy__msg__ActionResponse * data =
      (bt_interfaces_dummy__msg__ActionResponse *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bt_interfaces_dummy__msg__ActionResponse__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bt_interfaces_dummy__msg__ActionResponse__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bt_interfaces_dummy__msg__ActionResponse__copy(
