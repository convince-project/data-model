...
#include "bt_interfaces_dummy/msg/detail/action_response__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bt_interfaces_dummy::msg::ActionResponse;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bt_interfaces_dummy::msg::ActionResponse *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bt_interfaces_dummy::msg::ActionResponse *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ActionResponse__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const bt_interfaces_dummy::msg::ActionResponse *>(
...
static size_t _ActionResponse__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ActionResponse(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ActionResponse__callbacks = {
...
static rosidl_message_type_support_t _ActionResponse__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ActionResponse__callbacks,
...
{
  return &bt_interfaces_dummy::msg::typesupport_fastrtps_cpp::_ActionResponse__handle;
}
