...
static const _IsFollowed_type_support_symbol_names_t _IsFollowed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, people_detector_filter_interfaces_dummy, msg, IsFollowed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, people_detector_filter_interfaces_dummy, msg, IsFollowed)),
  }
};
...
{
  return &::people_detector_filter_interfaces_dummy::msg::rosidl_typesupport_cpp::IsFollowed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, people_detector_filter_interfaces_dummy, msg, IsFollowed)() {
  return get_message_type_support_handle<people_detector_filter_interfaces_dummy::msg::IsFollowed>();
}
