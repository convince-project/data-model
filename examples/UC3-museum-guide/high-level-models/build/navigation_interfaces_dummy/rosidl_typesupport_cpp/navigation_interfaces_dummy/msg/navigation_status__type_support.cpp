...
static const _NavigationStatus_type_support_symbol_names_t _NavigationStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigation_interfaces_dummy, msg, NavigationStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, navigation_interfaces_dummy, msg, NavigationStatus)),
  }
};
...
{
  return &::navigation_interfaces_dummy::msg::rosidl_typesupport_cpp::NavigationStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, navigation_interfaces_dummy, msg, NavigationStatus)() {
  return get_message_type_support_handle<navigation_interfaces_dummy::msg::NavigationStatus>();
}
