...
#include "navigation_interfaces_dummy/msg/detail/navigation_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = navigation_interfaces_dummy::msg::NavigationStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const navigation_interfaces_dummy::msg::NavigationStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<navigation_interfaces_dummy::msg::NavigationStatus *>(
    untyped_ros_message);
...
{
  return &navigation_interfaces_dummy::msg::typesupport_fastrtps_cpp::_NavigationStatus__handle;
}
