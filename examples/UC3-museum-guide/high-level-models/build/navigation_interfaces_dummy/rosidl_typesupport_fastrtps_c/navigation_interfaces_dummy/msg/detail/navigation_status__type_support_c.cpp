...
#include "navigation_interfaces_dummy/msg/detail/navigation_status__rosidl_typesupport_fastrtps_c.h"
...
using _NavigationStatus__ros_msg_type = navigation_interfaces_dummy__msg__NavigationStatus;
  ...
  void * untyped_ros_message)
{
  ...
  _NavigationStatus__ros_msg_type * ros_message = static_cast<_NavigationStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
...
size_t get_serialized_size_navigation_interfaces_dummy__msg__NavigationStatus(
  const void * untyped_ros_message,
...
static uint32_t _NavigationStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_navigation_interfaces_dummy__msg__NavigationStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_navigation_interfaces_dummy
size_t max_serialized_size_navigation_interfaces_dummy__msg__NavigationStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = navigation_interfaces_dummy__msg__NavigationStatus;
    is_plain =
      (
...
static size_t _NavigationStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_navigation_interfaces_dummy__msg__NavigationStatus(
...
static message_type_support_callbacks_t __callbacks_NavigationStatus = {
  "navigation_interfaces_dummy::msg",
  "NavigationStatus",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigation_interfaces_dummy, msg, NavigationStatus)() {
